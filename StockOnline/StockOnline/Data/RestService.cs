...
namespace StockOnline.Data
{
    public class RestService
    {
        ...
        public async Task<Token> Login(Users users) {
            var postData = new List<KeyValuePair<string, string>>();
            postData.Add(new KeyValuePair<string, string>("grant_type", grant_type));
            postData.Add(new KeyValuePair<string, string>("username", users.Username));
            postData.Add(new KeyValuePair<string, string>("password", users.Password));
